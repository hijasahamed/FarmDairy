...
class AddStockButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        addMilkStockForm(context: context, isDarkMode: isDarkMode, screenSize: screenSize,isReduceStock: false);
      },
      child: UpdateButtonWidget(screenSize: screenSize, isDarkMode: isDarkMode,isReduceStock: false,),
    );
  }
}